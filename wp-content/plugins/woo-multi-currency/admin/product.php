		...
		foreach ( $currencies as $currency ) {
			if ( $currency != $this->settings->get_default_currency() ) {
                ...
                <div style="border-left: 5px solid #f78080;">
                    <p class="form-field ">
                        <label for="_regular_price_wmcp_<?php echo esc_attr( $currency ); ?>"><?php echo __( 'Regular Price', 'woo-multi-currency' ) . ' (' . $currency . ')'; ?></label>
                    ...
                    <p class="form-field ">
                        <label for="_sale_price_wmcp_<?php echo esc_attr( $currency ); ?>"><?php echo __( 'Sale Price', 'woo-multi-currency' ) . ' (' . $currency . ')'; ?></label>
